...
const Invite: NextPage = () => {
  ...
  return (
    <Layout mt={16}>
      <FlexColumn>
        <Text mb={4} fontSize={[16, 24]} color="gray" fontWeight="bold">Invite someone to the test</Text>
        <Text mb={4} fontSize={[16, 24]}>
          During the test, you will be chatting with either this person or a machine (50/50).
          You’ll have 7 minutes to make your guess, after that you’ll be shown the answer.
        </Text>
        ...
        <Flex w="full" flexWrap="wrap" justify="center" align="center">
          ...
          <PrimaryButton size="md" onClick={onCopy} mt={[4, 4, 0]} ml={[0, 0, 4]}>
